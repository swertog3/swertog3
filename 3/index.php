...
// Проверяем ошибки.
$errors = FALSE;
if (empty($_POST['fio'])  || !preg_match('/^[a-zA-zА-Яа-яЁё ]+$/', $_POST['fio']) || strlen($_POST['fio'])<5 || !strlen($_POST['fio'])>100) {
...
if (empty($_POST['number']) || !preg_match('/^\+?[1-9]\d{1,14}$/', $_POST['number'])) {
